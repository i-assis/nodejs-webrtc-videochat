...
const Message = ({ author, content, sameAuthor, messageCreatedByMe }) => {
  const alignClass = messageCreatedByMe
    ? "message_align_right"
    : "message_align_left";
  const authorText = messageCreatedByMe ? "You" : author; // author from props
  ...
  return (
    <div className="messages_container">
      {dummyMessages.map((message, index) => {
        const sameAuthor = // is current message of same author as previous ?
